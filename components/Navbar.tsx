    ...
    return (
        <>
            <nav className={'  py-10 md:py-0 px-8 md:px-20 flex items-center  justify-between md:justify-start max-w-7xl mx-auto text-lg  '}>
                ...
                {/* 2 */}
                <div className={`${showMe ? '' : 'hidden'}    md:flex absolute md:static     md: items-center  rounded-xl    top-24  bg-Violet  md:bg-transparent   md:md:text-gray-400 text-white md:justify-between md:w-full flex-col md:flex-row  inset-x-0 mx-8 z-50 `}>
                    {/* 1 */}
