...
function Hero() {
    return (
        <div className=' static md:ml-16   flex flex-col md:flex-row mb-[10rem] ' >
            {/* Image div */}
            ...
            <div className='mx-10 md:mx-0 order-2 md:order-1 flex flex-col items-center md:items-start  text-center md:text-left gap-4 md:h-[28rem] md:w-[60rem]  md:justify-center '>
                ...
                <div className='hover:opacity-50 cursor md:mt-4  text-md text-center  bg-Cyan  px-10 py-3 text-white rounded-full font-semibold'>Get Started</div>
            </div>
